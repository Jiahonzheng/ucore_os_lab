 ...
 * The w-suffix functions are word-width.
 */

/*
 * inb - do low-level port input. It reads byte-width @data from @port.
 */
...
/*
 * outb - do low-level port output. It sends byte-width @data to @port.
 */
static inline void outb(uint16_t port, uint8_t data) {
...
/*
 * outw - do low-level port output. It sends word-width @data to @port.
 */
static inline void outw(uint16_t port, uint16_t data) {
...
/**
 * read_ebp - read the value of current ebp.
 */
