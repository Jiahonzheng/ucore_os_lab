...
static int sys_yield(uint32_t arg[]) { return do_yield(); }
...
static int sys_getpid(uint32_t arg[]) { return current->pid; }
...
static int (*syscalls[])(uint32_t arg[]) = {
    ...
    [SYS_getpid] sys_getpid, [SYS_putc] sys_putc,   [SYS_pgdir] sys_pgdir,
};
